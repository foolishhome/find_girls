...
public class IcsProgressBar extends View {
    ...
    private static final int[] ProgressBar = new int[]{android.R.attr.maxWidth, android.R.attr.maxHeight, android.R.attr.max, android.R.attr.progress, android.R.attr.secondaryProgress, android.R.attr.indeterminate, android.R.attr.indeterminateOnly, android.R.attr.indeterminateDrawable, android.R.attr.progressDrawable, android.R.attr.indeterminateDuration, android.R.attr.indeterminateBehavior, android.R.attr.minWidth, android.R.attr.minHeight, android.R.attr.interpolator, android.R.attr.animationResolution,};
    ...
    public IcsProgressBar(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        ...
        final int resID = a.getResourceId(
                /*com.android.internal.R.styleable.*/ProgressBar_interpolator, android.R.anim.linear_interpolator); // default to linear interpolator
        if (resID > 0) {
