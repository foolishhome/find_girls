...
{
    UIColor * _textColorBackup;
}
@property (nonatomic, getter = isSelected) BOOL selected;
@property (nonatomic) UIColor *indicatorColor;
@property (nonatomic) BOOL setTextColorAsIndicatorColor;
@end
...
- (void)setSelected:(BOOL)selected {
    ...
    if (_setTextColorAsIndicatorColor) {
        for (UIView * v in self.subviews) {
            if ([v isKindOfClass:[UILabel class]]) {
                UILabel * label = (UILabel*)v;
                if (selected) {
                    _textColorBackup = label.textColor;
                    label.textColor = _indicatorColor;
                } else if (_textColorBackup){
                    label.textColor = _textColorBackup;
                }
            }
        }
    }
...
- (void)switchTab:(int)tabIndex {
    ...
    __block NSUInteger index = tabIndex;
...
- (void)defaultSettings {
    ...
    _setTextColorAsIndicatorColor = NO;
}
- (void)reloadData {
...
- (TabView *)tabViewAtIndex:(NSUInteger)index {
    ...
    if ([[_tabs objectAtIndex:index] isEqual:[NSNull null]]) {
        ...
        tabView.setTextColorAsIndicatorColor = _setTextColorAsIndicatorColor;
